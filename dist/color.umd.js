...
* - ISC license
 */
(function(g,f){typeof exports==='object'&&typeof module!=='undefined'?f(exports):typeof define==='function'&&define.amd?define(['exports'],f):(g=typeof globalThis!=='undefined'?globalThis:g||self,f(g.Color={}));})(this,(function(exports){'use strict';const convertHexToRgb = function (hex) {
	...
	return output;
};exports.generateVariant=generateVariant;exports.hexToHsl=convertHextoHsl;exports.hexToRgb=convertHexToRgb;exports.hslToHex=convertHslToHex;exports.hslToRgb=convertHslToRgb;exports.rgbToHex=convertRgbToHex;exports.rgbToHsl=convertRgbToHsl;}));